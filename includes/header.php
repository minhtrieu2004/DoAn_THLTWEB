...
// Lấy username từ session để hiển thị trong header
                ...
                <div class="d-flex align-items-center">
                    <?php if ($is_logged_in): ?>
                        <?php if ($user_role === 'admin'): ?>
                            <a href="../admin/admin_products.php" class="btn btn-warning me-2 fw-bold" style="background-color: #cd7759; border-color: #cd7759;">
                                <i class="bi bi-gear-fill"></i> Trang Quản Trị
                            </a>
                        <?php else: ?>
                            <a href="../public/profile.php" class="btn btn-primary me-2 fw-bold" style="background-color: #5c4942ff; border-color: #cd7759;">
                                <i class="bi bi-person-fill"></i> Hồ sơ (<?php echo htmlspecialchars($current_username ?: ''); ?>)
                            </a>
                        <?php endif; ?>

                        <a href="../public/logout.php" class="btn btn-danger fw-bold me-2" style="background-color: #957d77ff;">
                            <i class="bi bi-box-arrow-right me-2"></i> Đăng xuất
                        </a>
                    <?php else: ?>
                        <a href="../public/login.php" class="btn btn-primary fw-bold me-2" style="background-color: #413531ff; border-color: #cd7759;">
